        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li class="menu-title">VISIT MAIN WEBSITE</li>
                    ...
                    <li><a class="" href="../index.php" aria-expanded="false">
                            ...
                            <span class="nav-text">Go To Homepage</span>
                        </a>
                    </li>
                    ...
                    <?php if ((int)$_SESSION['user_data']['role'] === ROLE_ADMIN): ?>
                        ...
                        <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                <li><a href="create-service.php">Add a Service</a></li>
                                <li><a href="view-services.php">View All Services</a></li>
                            </ul>
                        </li>
