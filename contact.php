...
<section id="main-banner-page" class="position-relative page-header about-header parallax section-nav-smooth" 
    style="background-image: url('assets/images/about/contact.jpg'); background-size: cover; background-position: center;">
...
<section id="contact-us" class="bglight position-relative padding">
    <div class="container whitebox py-5">
                ...
                <div class="contact-meta px-2 text-center text-md-start">
                    ...
                    <ul class="social-icons mt-4 mb-0">
                        ...
                        <?php if (!empty($display_settings['whatsapp'])): ?>
                            <li><a href="https://wa.me/<?php echo $display_settings['whatsapp']; ?>" target="_blank"><i class="fab fa-whatsapp"></i></a></li>
                        <?php endif; ?>
                    </ul>
                </div>
            </div>
        ...
        <div class="row mt-5">
            <?php
                $contactBoxes = [
                    ['icon' => 'fas fa-mobile-alt', 'title' => $display_settings['phone'] ?? '+234XXXXXXXXXX', 'subtitle' => ''],
                    ['icon' => 'fas fa-map-marker-alt', 'title' => $display_settings['office_address'] ?? 'Office address not available', 'subtitle' => ''],
                    ['icon' => 'far fa-envelope', 'title' => $display_settings['email'] ?? 'info@dbandzee.com', 'subtitle' => ''],
                    ['icon' => 'far fa-clock', 'title' => $display_settings['office_hours'] ?? 'Mon-Fri: 9am - 5pm', 'subtitle' => ''],
                ];
                foreach ($contactBoxes as $box):
            ?>
            <div class="col-lg-3 col-md-6 col-sm-6 text-center top60">
                <div class="contact-box">
                    <span class="icon-contact defaultcolor"><i class="<?php echo $box['icon']; ?>"></i></span>
                    <p class="bottom0"><?php echo $box['title']; ?></p>
                    <?php if(!empty($box['subtitle'])): ?>
                        <p class="d-block"><?php echo $box['subtitle']; ?></p>
                    <?php endif; ?>
                </div>
            </div>
            <?php endforeach; ?>
